...
_base_ = './yoloms_syncbn_fast_2xb4-3x_dior_previous.py'

pretrain = ('https://modelscope.cn/models/wokaikaixinxin/ai4rs/resolve/master/rotated_yoloms/'
            'yoloms_previous_version_coco/yoloms-xs_syncbn_fast_8xb32-300e_coco_previous.pth')

deepen_factor = 1 / 3  # Depth scaling factor
widen_factor = 0.4  # Width scaling factor
