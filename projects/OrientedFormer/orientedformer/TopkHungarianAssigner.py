...
class TopkHungarianAssigner(TaskAlignedAssigner):
    ...
    def assign(self,
        ...
        pred_instances.scores = inverse_sigmoid(pred_scores)
        # NOTE: the scores of pred_instances should inverse_sigmoid !!!!!!!!!!!!!
        # Because  sigmoid_geometric_mean() in forward_single and FocalLossCost !!!!
